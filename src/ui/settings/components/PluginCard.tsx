...
export default function PluginCard({
  ...
  return (
    <Card
      ...
      headerIcon={
        plugin.manifest.vendetta?.icon || "ic_application_command_24px"
      }
      toggleType="switch"
      ...
      overflowActions={[
        ...
        },
        {
          ...
          onPress: () => {
            ...
            showToast(
              `${plugin.update ? "Enabled" : "Disabled"} updates for ${
              ...
              onConfirm: () => {
                stopThenStart(plugin, () => {
                  try {
                    ...
                    showToast(
                      `Cleared data for ${plugin.manifest.name}.`,
                      getAssetIDByName("trash")
                    );
                  } catch {
                    showToast(
                      `Failed to clear data for ${plugin.manifest.name}!`,
                      getAssetIDByName("Small")
                    );
                  }
                });
