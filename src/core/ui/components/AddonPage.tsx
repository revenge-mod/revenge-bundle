        ...
        <AlertModal
            ...
            extraContent={
                <Stack style={{ marginTop: -12 }}>
                    ...
                    />
                    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ gap: 8 }}>
                        <Button
                            size="sm"
                            variant="tertiary"
            ...
            actions={
                <Stack>
                    ...
                    />
                    <AlertActionButton disabled={isFetching} text="Cancel" variant="secondary" />
                </Stack>
            }
        />
    );
...
export default function AddonPage<T extends object>({ CardComponent, ...props }: AddonPageProps<T>) {
    ...
    if (results.length === 0 && !search) {
        return (
            <View style={{ gap: 32, flexGrow: 1, justifyContent: "center", alignItems: "center" }}>
        ...
        <View style={{ paddingBottom: 8 }}>
            {BunnySettings.isSafeMode() && (
                <View style={{ marginBottom: 10 }}>
                    <HelpMessage messageType={0}>{props.safeModeHint?.message}</HelpMessage>
    ...
    return (
        <ErrorBoundary>
            ...
            />
            {props.installAction && (
                <FloatingActionButton icon={findAssetId("PlusLargeIcon")} onPress={onInstallPress} />
            )}
        </ErrorBoundary>
    );
}
