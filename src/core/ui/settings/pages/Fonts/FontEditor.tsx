...
import type { FontManifest, OldFontDefinition } from "@lib/addons/fonts/types";
...
function RevengeFontsExtractor({
    fonts,
    setName,
}: {
    ...
    return (
        <View style={{ padding: 8, paddingBottom: 16, gap: 12 }}>
            <TextInput
                autoFocus
                size="md"
...
function promptActionSheet(Component: any, fontEntries: Record<string, string>, props: any) {
    showSheet("FontEditorActionSheet", () => (
        <ErrorBoundary>
            <ActionSheet>
            ...
            <Stack style={{ paddingVertical: 24, paddingHorizontal: 12 }} spacing={12}>
                {!props.id ? (
                    <TableRowGroup title="Import">
                        {/** @ts-ignore */}
                        {ColorManager.getCurrentManifest()?.fonts && (
                            <TableRow
                        ...
                        <TableRow
                            ...
                            onPress={() =>
                                promptActionSheet(JsonFontImporter, fontEntries, { setName, setSource, setId })
                            }
                        />
                    </TableRowGroup>
                ) : (
                ...
                <TextInput size="lg" value={id} label="Font ID" placeholder="whitney" onChange={setId} />
                <TextInput size="lg" value={name} label={Strings.FONT_NAME} placeholder="Whitney" onChange={setName} />
